// Socket Object Primitive
// Provides object-oriented interface to socket operations
// Wraps both TCP and UDP sockets with unified API
...
namespace standard
{
    namespace sockets
    {
        ...
        {
            int fd;
            int type;           // socket_type enum
            int error_state;    // socket_error enum
            bool is_server;
            bool connected;
            ...
            def __init(int sock_type) -> this
            {
                ...
                if (sock_type == socket_type.TCP)
                {
                    this.fd = tcp_socket();
                }
                elif (sock_type == socket_type.UDP)
                {
                    this.fd = udp_socket();
                }
                else
