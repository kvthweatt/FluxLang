...
entry:
  ...
  store i32 5, i32* %"x"
  %"y" = alloca i32
  %"x_tied" = load i32, i32* %"x"
  %"x_valid" = alloca i1
  store i1 1, i1* %"x_valid"
  store i1 0, i1* %"x_valid"
  store i32 0, i32* %"x"
  store i32 %"x_tied", i32* %"y"
  %"y.1" = load i32, i32* %"y"
  %"y.2" = load i32, i32* %"y"
  call void @"standard__io__console__print__1__int__ret_void"(i32 %"y.2")
  ...
  call void @"standard__io__console__print__1__noopstr__ret_void"(i8* %"arg0_to_void_ptr")
  %"int_to_ptr" = inttoptr i1 0 to i8*
  %"deref" = load i8, i8* %"int_to_ptr"
  %"int_to_ptr.1" = inttoptr i8 %"deref" to i8*
  %"deref.1" = load i8, i8* %"int_to_ptr.1"
  ret i32 0
}
